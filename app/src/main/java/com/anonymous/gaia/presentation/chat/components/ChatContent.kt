...
import com.anonymous.gaia.components.ThreeDots
import com.anonymous.gaia.core.CHAT_GPT
import com.anonymous.gaia.core.EMPTY_QUESTION_MESSAGE
import com.anonymous.gaia.core.EMPTY_STRING
import com.anonymous.gaia.core.NO_QUESTIONS_MESSAGE
import com.anonymous.gaia.core.SEND
import com.anonymous.gaia.core.QUESTION_PLACEHOLDER
import com.anonymous.gaia.core.Utils.Companion.showMessage
                    ...
                    question.apply {
                        prompt?.let {
                            Text(
                                ...
                                text = "${question.createdBy}: ${question.prompt}",
                                fontSize = 15.sp
                            )
                        }
                        response?.let {
